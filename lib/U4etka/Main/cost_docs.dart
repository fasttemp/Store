...
class CostDocs extends StatefulWidget {
  const CostDocs({Key? key}) : super(key: key);

  @override
  State<CostDocs> createState() => _CostDocsState();
}

class _CostDocsState extends State<CostDocs> {
  ...
  Future getCosts() async {
    try {
      QuerySnapshot collection =
          await FirebaseFirestore.instance.collection('costs').get();
      ...
      body: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          Map<String, dynamic> data =
              costs[index].data() as Map<String, dynamic>;
          ...
          if (index == 0 ||
              (costs[index - 1].data() as Map<String, dynamic>)['data'] !=
                  data['data']) {
            isNewDate = true;
          }
