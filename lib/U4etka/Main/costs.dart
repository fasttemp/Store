...
class _CostsState extends State<Costs> {
  DocumentSnapshot? selectedBuyer;
  ...
  Future createCosts(
    ...
    try {
      await FirebaseFirestore.instance.collection('costs').doc().set({
        'data': data,
        'id': int.parse(id),
        'title': title,
            ...
            InkWell(
              onTap: () async {
                final selected = await Navigator.push<DocumentSnapshot>(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Buyers(
                              selectMode: true,
                            )));

                if (selected != null) {
                  setState(() {
                    selectedBuyer = selected;
                  });
                }
              },
              child: AbsorbPointer(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText:
                        selectedBuyer != null ? selectedBuyer!['name'] : null,
                    suffixIcon: selectedBuyer == null
                        ? Row(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          if (selected != null &&
            ...
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              content: Text('Товар уже добавлен',
